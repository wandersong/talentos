...
import 'm_a_i_n_my_profile_empresa_model.dart';
export 'm_a_i_n_my_profile_empresa_model.dart';

class MAINMyProfileEmpresaWidget extends StatefulWidget {
  const MAINMyProfileEmpresaWidget({Key? key}) : super(key: key);

  @override
  _MAINMyProfileEmpresaWidgetState createState() =>
      _MAINMyProfileEmpresaWidgetState();
}

class _MAINMyProfileEmpresaWidgetState extends State<MAINMyProfileEmpresaWidget>
    with TickerProviderStateMixin {
  late MAINMyProfileEmpresaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MAINMyProfileEmpresaModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mAINMyProfileEmpresaUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                                                  ...
                                                  onPressed: () async {
                                                    context.pushNamed(
                                                      ...
                                                      queryParameters: {
                                                        'userProfile':
                                                            serializeParam(
                                                          mAINMyProfileEmpresaUsersRecord
                                                              .reference,
                                                          ParamType
                                                              .DocumentReference,
                                                        ),
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          24.0, 0.0, 24.0, 0.0),
                                      child: Text(
                                        mAINMyProfileEmpresaUsersRecord.bio,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                      ),
                                    ),
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    'R\$${valueOrDefault<String>(
                                      mAINMyProfileEmpresaUsersRecord.salary,
                                      '0.00',
                                    )}',
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
